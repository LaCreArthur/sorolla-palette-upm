...
namespace SorollaPalette
{
    ...
    public class SorollaPaletteConfig : ScriptableObject
    {
        ...
        [Header("GameAnalytics (Required - Both Modes)")]
        [Tooltip("Game Key from GameAnalytics dashboard")]
        public string gaGameKey;
        
        [Tooltip("Secret Key from GameAnalytics dashboard")]
        public string gaSecretKey;
        
        [Header("AppLovin MAX (Optional in Prototype, Required in Full)")]
        ...
        [Header("Facebook SDK (Prototype Mode Only)")]
        [Tooltip("Facebook App ID - Only used in Prototype Mode")]
        ...
        [Tooltip("Adjust App Token - Only used in Full Mode")]
        public string adjustAppToken;
        
        [Tooltip("Adjust environment - Sandbox for testing, Production for live")]
        public AdjustEnvironment adjustEnvironment = AdjustEnvironment.Sandbox;
        
        [Header("Module Status (Read-Only)")]
        [Tooltip("Is MAX module enabled?")]
        public bool maxModuleEnabled;
        
        [Tooltip("Is Facebook module enabled?")]
        public bool facebookModuleEnabled;
        
        [Tooltip("Is Adjust module enabled?")]
        public bool adjustModuleEnabled;
